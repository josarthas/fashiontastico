    ...
    <div id="page-wrapper">
        ...
        <div>
            ...
            <section id="content" class="main">
                <?php include 'conexion.php'; $re=mysqli_query($con, "select * from productos where id=".$_GET[ 'id'])or die(mysqli_error()); while ($f=mysqli_fetch_array($re)) { ?>
                <center>
                    <img src="./productos/<?php echo $f['imagen'];?>" width="200px">
                    <br>
