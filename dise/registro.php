...
if ($post) {
   ...
   $sql = "INSERT INTO u467192330_compr(Nombre, Direccion,Usuario,Password) ".
...
?> 
   ...
   e-mail:<input type="Text" name="Direccion"><br>
...
?> 
						...
						<div class="inner">
							<ul class="actions">
								<li><a href="./login.php" class="button special">Inicia ya!</a></li>
							</ul>
						</div>
					</section>
							</section>
